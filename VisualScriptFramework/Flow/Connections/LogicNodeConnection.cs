...
namespace IoTLogic.Flow.Connections
{
    ...
    */
    ...
    public abstract class UnitConnection<TSourcePort, TDestinationPort> : GraphElement<LogicGraph>, IConnection<TSourcePort, TDestinationPort>
        ...
        where TDestinationPort : class, IUnitInputPort
    {
        ...
        protected UnitConnection(TSourcePort source, TDestinationPort destination)
        {
            ...
            if (source.LogicNode.Graph != destination.LogicNode.Graph)
            {
            ...
            {
                throw new InvalidConnectionException("Cannot create connections on the same LogicNode.");
            }

            sourceUnit = source.LogicNode;
            sourceKey = source.Key;
            destinationUnit = destination.LogicNode;
        ...
        //[Serialize]
        protected ILogicNode sourceUnit { get; private set; }

        //[Serialize]
        protected string sourceKey { get; private set; }

        //[Serialize]
        protected ILogicNode destinationUnit { get; private set; }
