...
namespace IoTLogic.Core.Reflection
{
    public static class TypeUtility
    {
        ...
        {
            Ensure.Ensure.That(nameof(openConstructedType)).IsNotNull(openConstructedType);
            Ensure.Ensure.That(nameof(closedConstructedType)).IsNotNull(closedConstructedType);
        ...
        public static Type MakeGenericTypeVia(this Type openConstructedType, Type closedConstructedType, Dictionary<Type, Type> resolvedGenericParameters, bool safe = true)
        {
            Ensure.Ensure.That(nameof(openConstructedType)).IsNotNull(openConstructedType);
            Ensure.Ensure.That(nameof(closedConstructedType)).IsNotNull(closedConstructedType);
            Ensure.Ensure.That(nameof(resolvedGenericParameters)).IsNotNull(resolvedGenericParameters);
