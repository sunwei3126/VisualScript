...
namespace IoTLogic.Core.Reflection
{
    public static class MemberUtility
    {
        ...
        {
            Ensure.Ensure.That(nameof(openConstructedMethod)).IsNotNull(openConstructedMethod);
            Ensure.Ensure.That(nameof(closedConstructedParameterTypes)).IsNotNull(closedConstructedParameterTypes);
        ...
        {
            Ensure.Ensure.That(nameof(parameterInfo)).IsNotNull(parameterInfo);
        ...
        {
            Ensure.Ensure.That(nameof(parameterTypes)).IsNotNull(parameterTypes);
        ...
        {
            Ensure.Ensure.That(nameof(genericArgumentTypes)).IsNotNull(genericArgumentTypes);
        ...
        {
            Ensure.Ensure.That(nameof(type)).IsNotNull(type);
        ...
        {
            Ensure.Ensure.That(nameof(fields)).IsNotNull(fields);
            Ensure.Ensure.That(nameof(type)).IsNotNull(type);
        ...
        {
            Ensure.Ensure.That(nameof(properties)).IsNotNull(properties);
            Ensure.Ensure.That(nameof(type)).IsNotNull(type);
        ...
        {
            Ensure.Ensure.That(nameof(constructors)).IsNotNull(constructors);
            Ensure.Ensure.That(nameof(type)).IsNotNull(type);
            Ensure.Ensure.That(nameof(parameterTypes)).IsNotNull(parameterTypes);
        ...
        {
            Ensure.Ensure.That(nameof(methods)).IsNotNull(methods);
            Ensure.Ensure.That(nameof(type)).IsNotNull(type);
            Ensure.Ensure.That(nameof(parameterTypes)).IsNotNull(parameterTypes);
