...
namespace VisualScript.Core.Reflection
{
    public static class AttributeUtility
    {
            ...
            public AttributeCache(MemberInfo element)
            {
                ...
                try
                {
                    ...
                    catch (InvalidCastException ex)
                    {
                        ...
                        Console.WriteLine($"Failed to fetch inherited attributes on {element}.\n{ex}");
                    }
                }
                catch (Exception ex)
                {
                ...
                {
                    Console.WriteLine($"Failed to fetch defined attributes on {element}.\n{ex}");
                }
            }
        ...
        public static bool CheckCondition(Type type, object target, string conditionMemberName, bool fallback)
        {
            ...
            {
                Console.WriteLine("Failed to check attribute condition: \n" + ex);
                return fallback;
            }
        }
