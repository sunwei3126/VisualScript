...
namespace IoTLogic.Core.Reflection
{
    ...
    public sealed class Member
    {
        ...
        {
            Ensure.Ensure.That(nameof(targetType)).IsNotNull(targetType);
            Ensure.Ensure.That(nameof(name)).IsNotNull(name);
        ...
        {
            Ensure.Ensure.That(nameof(targetType)).IsNotNull(targetType);
            Ensure.Ensure.That(nameof(fieldInfo)).IsNotNull(fieldInfo);
        ...
        {
            Ensure.Ensure.That(nameof(targetType)).IsNotNull(targetType);
            Ensure.Ensure.That(nameof(methodInfo)).IsNotNull(methodInfo);
        ...
        {
            Ensure.Ensure.That(nameof(targetType)).IsNotNull(targetType);
            Ensure.Ensure.That(nameof(constructorInfo)).IsNotNull(constructorInfo);
       ...
       // [DoNotSerialize]
        ...
        //[DoNotSerialize]
        private FieldInfo fieldAccessor;

        //[DoNotSerialize]
        private PropertyInfo propertyAccessor;

        //[DoNotSerialize]
        private MethodInfo methodInvoker;
       ...
       // [DoNotSerialize]
        ...
        public void Reflect()
        {
            ...
            foreach (var candidate in candidates)
            {
                ...
                else if (candidate.MemberType != memberType && !candidate.IsExtensionMethod())
                {
                    ...
                    Console.WriteLine($"Multiple members with the same name are of a different type: '{targetType.Name}.{name}'");
                    break;
                }
            }
        ...
        public object Invoke(object target)
        {
            ...
            if (source == Source.Method)
            {
                ...
                {
                    return methodInvoker.Invoke(target,null);
                }
                else
                {
                    return methodInvoker.Invoke(target, null);
        ...
        public object Invoke(object target, object arg0)
        {
            ...
            if (source == Source.Method)
            {
                if (isInvokedAsExtension)
                {
                    return methodInvoker.Invoke(target, new object[] { arg0 });
                }
                else
                {
                    return methodInvoker.Invoke(target, new object[] { arg0 });
        ...
        public object Invoke(object target, object arg0, object arg1)
        {
            ...
            if (source == Source.Method)
            {
                if (isInvokedAsExtension)
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1 });
                }
                else
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1 });
        ...
        public object Invoke(object target, object arg0, object arg1, object arg2)
        {
            ...
            if (source == Source.Method)
            {
                if (isInvokedAsExtension)
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1, arg2 });
                }
                else
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1, arg2 });
        ...
        public object Invoke(object target, object arg0, object arg1, object arg2, object arg3)
        {
            ...
            if (source == Source.Method)
            {
                if (isInvokedAsExtension)
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1, arg2, arg3 });
                }
                else
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1, arg2, arg3 });
        ...
        public object Invoke(object target, object arg0, object arg1, object arg2, object arg3, object arg4)
        {
            ...
            if (source == Source.Method)
            {
                if (isInvokedAsExtension)
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1, arg2, arg3, arg4 });
                }
                else
                {
                    return methodInvoker.Invoke(target, new object[] { arg0, arg1, arg2, arg3, arg4 });
